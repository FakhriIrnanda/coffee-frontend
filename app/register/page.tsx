...
const formatField = (key: string) => key.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
...
export default function RegisterPage() {
    ...
    return (
        <main className="min-h-screen bg-stone-900 flex flex-col items-center justify-center px-4 py-12">
            <motion.div
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-stone-800" style={{fontFamily: 'Georgia, serif'}}>Join Mercys</h1>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                {field.type === 'password' && (
                                    ...
                                    >
                                        {visiblePasswords[field.key] ? <EyeOffIcon /> : <EyeIcon />}
                                    </button>
                                )}
                            </div>
                        </motion.div>
